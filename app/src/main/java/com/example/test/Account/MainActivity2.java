                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity2.this, "Đăng ký thành công: " + userEmail, Toast.LENGTH_SHORT).show();
                        } else {
                            // Sign up failed
                            String errorMessage = (task.getException() != null) ? task.getException().getMessage() : "Đăng ký thất bại";
                            Toast.makeText(MainActivity2.this, "Lỗi đăng ký: " + errorMessage, Toast.LENGTH_SHORT).show();
